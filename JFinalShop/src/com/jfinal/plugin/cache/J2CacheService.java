...
public class J2CacheService {
    ...
    private static final String default_cache = "system";
    ...
    public static Object get(String region, Object key) {
        ...
        logger.debug("get[{},{},L{}]=>{}", new Object[]{obj.getRegion(), obj.getKey(), obj.getLevel(), obj.getValue()});
        return obj.getValue();
    }

    public static void set(String region, Object key, Object value) {
        logger.debug("set[{},{}]<={}", new Object[]{region, key, value});
